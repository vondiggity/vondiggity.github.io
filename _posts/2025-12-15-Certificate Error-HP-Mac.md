...
From there, I generated a new self-signed certificate. I set the expiration to three years, figuring the printer would likely be replaced before then based on recent history with many HP Laserjets.
